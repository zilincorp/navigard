...
// Письмо
$mail->isHTML(true); 
$mail->Subject = "Новый заказ на 8321 с сайта 999-911.рф"; // Заголовок письма
$mail->Body    = "<strong>Новый заказ на 8321 с сайта 999-911.рф</strong> <br> Имя: $name <br> Телефон: $number <br> Почта: $email"; // Message

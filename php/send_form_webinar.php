...
// Письмо
$mail->isHTML(true); 
$mail->Subject = "Регистрация на ближайший вебинар"; // Заголовок письма
$mail->Body    = "<strong>Регистрация на ближайший вебинар</strong> <br> Имя: $name <br> Телефон: $number <br> Почта: $email"; // Message
